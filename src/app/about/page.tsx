...
export default function About() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 relative">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,217,232,0.1)_1px,transparent_1px),linear-gradient(rgba(5,217,232,0.1)_1px,transparent_1px)] bg-[size:50px_50px]" />
      
      <div className="relative flex place-items-center z-10 w-full max-w-4xl mt-16">
        <div className="space-y-12 w-full backdrop-blur-sm bg-cyber-darker/30 p-8 cyber-border">
          <h1 className="font-cyber text-4xl font-bold text-cyber-pink text-center mb-12">
            About the doomsd<span className="text-cyber-blue animate-electric">AI</span> clock
          </h1>
          
          <div className="space-y-8 text-white/80">
            <section className="space-y-4">
              <h2 className="font-cyber text-2xl text-cyber-blue mb-4">Project Overview</h2>
            ...
            <section className="space-y-4">
              <h2 className="font-cyber text-2xl text-cyber-blue mb-4">Methodology</h2>
              <p className="font-cyber text-sm md:text-base">
            ...
            <section className="space-y-4">
              <h2 className="font-cyber text-2xl text-cyber-blue mb-4">Historical Context</h2>
              <p className="font-cyber text-sm md:text-base">
            ...
            <section className="space-y-4">
              <h2 className="font-cyber text-2xl text-cyber-blue mb-4">AI Enhancement</h2>
              <p className="font-cyber text-sm md:text-base">
